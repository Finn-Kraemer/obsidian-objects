...
Open Settings in the Obsidian application.

In the sidebar, select Community plugins → Obsidian Objects.

In Template Folder, enter the path to the folder where you store your template files (for example, Templates).

Under Trigger → Template Mappings, select Add new mapping to create a new trigger.
...
Type the name for your new note.

Immediately after the name, type your trigger keyword. For example: Weekly Review@meeting.

From the suggestion menu that appears, select the trigger you want to use.
